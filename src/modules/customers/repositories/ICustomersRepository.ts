...
export default interface ICustomersRepository {
    ...
    findAllCustomersFromCompany(company_id: string, page: number): Promise<[Customer[], number] | undefined>;
    findNewlyAddCustomers(company_id: string): Promise<Customer[] | undefined>;
    findCustomerByName(company_id: string, name: string, page: number): Promise<[Customer[], number] | undefined>;
